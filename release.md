...
1. Open a Pull Request on Github for this branch with the following naming convention `YYYY-DD-MM release/XX.YY.ZZ`. YYYY-MM-DD should be the release date, not the current date.
