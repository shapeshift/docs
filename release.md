...
1. Build the ephemeral environment for testing: On Github, create a pull request into the Main branch for this new release branch with the following naming convention: `chore: releases/v1.0.4 do not merge`. Get the URL for this PR from Github.
